<?php
    ...
    class WordpressRepository
    {
        ...
        protected function findOrCreateCustomersFromSubscription($data)
        {
            ...
            foreach ($data as $email => $d) {
                ...
                $customers[] = [
                    ...
                    'meta_data' => [
                        ['key' => 'gp_id', 'value' => $customer["sfRecord"]->GP_CustID__c],
        ...
        {
            $response = self::createOrdersFromSubscriptions($data);
            $idToEmail = [];
        ...
        protected function createOrdersFromSubscriptions($data)
        {
            ...
            foreach ($data as $email => $record) {
                ...
                $orders[] = [
                    ...
                    'set_paid' => $paid,
                    'status' => $status,
                    'order_date' => Carbon::parse($order["subscription"]->start_date)->unix(),
